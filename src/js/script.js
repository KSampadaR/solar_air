...
// const solar = document.getElementById('solar-btn');
...
async function getWeatherByLocation(city) {
  ...
  // document.getElementById('solar-btn').textContent = `View solar For ${city}`;
...
function closeAllPopups() {
  ...
  // document.getElementById('solar-btn').style.display = 'block';
...
// document.getElementById('solar-btn').addEventListener('click', toggleSolarPower);

// document.getElementById('solar-btn').style.display = 'block'; // To show the button when required

// document.getElementById('solar-btn').addEventListener('click', toggleSolarPower);

// function toggleSolarPower() {
//   alert('Displaying Solar Power Generation Data for the selected location!');
// }
